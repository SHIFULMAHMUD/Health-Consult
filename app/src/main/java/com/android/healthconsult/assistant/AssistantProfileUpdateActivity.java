...
import com.android.healthconsult.doctor.DoctorProfileActivity;
...
public class AssistantProfileUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assistant_profile_update);
...
//For choosing account type and open alert dialog
        sptypeET.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AssistantProfileUpdateActivity.this);
    ...
    public void  UpdateProfile()
    {
        ...
        if (name.isEmpty()) {
            ...
            Toasty.error(AssistantProfileUpdateActivity.this, "Please select speciality type !", Toast.LENGTH_SHORT).show();
        }
            ...
            Toasty.error(AssistantProfileUpdateActivity.this, "Please select gender !", Toast.LENGTH_SHORT).show();
        }
            ...
            StringRequest stringRequest=new StringRequest(Request.Method.POST, Constant.UPDATE_DOC_PROFILE_URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.trim().equals("success")) {
                        loading.dismiss();
                        Intent intent = new Intent(AssistantProfileUpdateActivity.this, DoctorProfileActivity.class);
                        Toasty.success(AssistantProfileUpdateActivity.this, "Information Updated", Toast.LENGTH_SHORT).show();
                        ...
                        Toasty.error(AssistantProfileUpdateActivity.this, "Update Failed!", Toast.LENGTH_SHORT).show();
                        loading.dismiss();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toasty.error(AssistantProfileUpdateActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_SHORT).show();
                            loading.dismiss();
                        }
                    }
