...
import com.android.healthconsult.assistant.AssistantProfileUpdateActivity;
                ...
                for (int i = 0; i < result.length(); i++) {
                    ...
                    updateBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent=new Intent(DoctorProfileActivity.this, AssistantProfileUpdateActivity.class);
